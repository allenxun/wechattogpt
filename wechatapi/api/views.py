...
TOKEN = 'helloworld'
openai.api_key = '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'
...
def index(request):
    if request.method == 'GET':
        ...
        temp000 = message_data(ToUserName=msg.source,FromUserName=msg.target,CreateTime=msg.time,MsgType=msg.type,Content=msg.content,MsgId='0',MsgDataId='0',Idx='0')
        temp000.save()
